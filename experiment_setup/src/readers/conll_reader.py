...
#    train_iter = CoNLLIterator(_path+'/data/CoNLL/CoNLL_AIDA-YAGO2-dataset.tsv', split='testb')
#    for i, m in enumerate(train_iter.mention_iterator()):
#        print m.gold_sense_url()
#        print m.gold_sense_id()
#        print m.mention_text()
#        print m.left_context(10)
#        print m.right_context(10)
#        print ' - '
