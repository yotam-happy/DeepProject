...
A different type of NED evaluation, suggested by \newcite{Ratinov2011}, is completely composed out of paragraphs from Wikipdia pages. In this Wiki dataset cross-reference hyperlinks act as mentions surface, thus implying that data is edited in a more crowd-sourced fashion than the previous benchmarks.

The common ground of all former data sets is their coherent and well reviewed structure, as it may be expected from mighty information and media organizations. When focusing only on this type of data we overlook the fact that nowadays most information is consumed through many diverse sources, such as blogs, social network posts and micro-group chats, which feature significantly higher contextual noise as they lack redaction and editing.
