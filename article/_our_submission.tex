...
\begin{document}
	...
	In this work, we investigate the task of NED in a different setting, where only local and noisy context is available. Domains such as web page fragments, social media, or questions, are shorter and not as well curated as news items and Wikipedia. Such domains might lack the sufficient coherence and context for global models to pay off, and can contain considerable amounts of contextual noise. Take for example this fragment taken from the web:
