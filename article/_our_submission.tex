...
We trained for a single \todo{YOTAM: I have better a training regime} epoch with $2.6M$ mentions and $k=5$ for corrupt example generation.\todo{The number of mentions is redundant (mentioned in 3). The two hyperparameters, 1 epoch and 5 negative samples, are important. Can they be moved to 5.0?}
