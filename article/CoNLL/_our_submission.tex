...
%\author[1]{Yotam Eshel}
%\author[2]{Noam Cohen}
%\author[1,3]{Kira Radinsky}
%\author[1]{Shaul Markovitch}
%\author[4]{\authorcr Ikuda Yamada}
%\author[5]{Omer Levi}
%\affil[1]{Department of Computer Science, \authorcr Technion - Israel Institute of Technology, Haifa, Israel}
%\affil[2]{Department of Biomedical Engineering \authorcr Technion - Israel Institute of Technology, Haifa, Israel}
%\affil[3]{eBay Research \& Technion  – Israel Institute of Technology}
%\affil[4]{Studio Ousia, 4489-105-221 Endo, Fujisawa, Kanagawa, Japan}
%\affil[5]{Paul G. Allen School of Computer Science and Engineering, \authorcr University of Washington, Seattle, WA}

\author{
	\begin{minipage}{11em}
		\begin{center}
		Yotam Eshel \\
		{\normalfont Technion, Haifa, Israel \\
		\texttt{yotamesh@\\technion.ac.il}}
		\end{center}
	\end{minipage}
	\begin{minipage}{11em}
		\begin{center}
	...
	\begin{minipage}{13em}
		\begin{center}
			Kira Radinsky \\
		{\normalfont Technion \& eBay research \\
			\texttt{kirar@\\technion.ac.il}}
		\end{center}
	\end{minipage} \\ \\
	\begin{minipage}{10em}
		\begin{center}
			\textbf{Shaul Markovitch} \\
			{\normalfont Technion, Haifa, Israel \\
				\texttt{shaulm@\\technion.ac.il}}
		\end{center}
	\end{minipage}
	\begin{minipage}{10em}
		\begin{center}
			\textbf{Ikuda Yamada} \\
			{\normalfont Studio Ousia, Fujisawa, Kanagawa, Japan \\
	...
	\begin{minipage}{15em}
		\begin{center}
			\textbf{Omer Levi} \\
			{\normalfont Paul G. Allen School, University of Washington, Seattle, WA \\
